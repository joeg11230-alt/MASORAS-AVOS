  ...
  function applyBranding(){
    ...
    try{
      ...
      if(header){
        ...
        if(h2){h2.textContent='MASORAS AVOS';h2.style.cssText='position:absolute;left:28px;top:22px;margin:0;font-size:29px;line-height:1.1;font-weight:900;letter-spacing:1.4px;color:#fff;text-shadow:0 2px 4px rgba(0,0,0,.18);';}
        ...
        hebrew.style.cssText="position:absolute;right:28px;top:20px;margin:0;font-size:31px;line-height:1.1;font-weight:900;color:#fff;white-space:nowrap;text-align:right;text-shadow:0 2px 4px rgba(0,0,0,.18);font-family:'Arial Hebrew','Noto Sans Hebrew',Arial,sans-serif;";
        const greeting=header.querySelector('#dashboardGreeting,#greetingText,.dashboard-greeting');
        const clock=header.querySelector('#dashboardTime,#currentTime,.dashboard-time');
        if(greeting){greeting.style.cssText='position:absolute;left:50%;top:25px;transform:translateX(-50%);font-size:17px;font-weight:800;color:#fff;white-space:nowrap;margin:0;';}
        if(clock){clock.style.cssText='position:absolute;left:50%;top:50px;transform:translateX(-50%);font-size:13px;font-weight:700;color:#fff;margin:0;white-space:nowrap;';}
      }
