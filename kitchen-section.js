  ...
  function ensureKitchen(){
    ...
    section.innerHTML=`<div class="card"><div class="section-head" style="margin-top:0;border-top:0;padding-top:0"><div><h2 style="margin:0">Kitchen</h2><div class="muted">Kitchen operations</div></div></div>
      <div id="kitchenSubTabs" class="row" style="margin-top:14px;border-bottom:1px solid #d9dee7;padding-bottom:10px">
        <button type="button" data-kitchen-page="menu">Menu</button><button type="button" data-kitchen-page="prep">Prep Amount</button><button type="button" data-kitchen-page="recipes">Recipes</button><button type="button" data-kitchen-page="inventory">Inventory</button><button type="button" data-kitchen-page="needs">Needs Ordering</button><button type="button" data-kitchen-page="queues">Order Queue</button><button type="button" data-kitchen-page="todo">To Do</button>
      </div>
      <div id="kitchenLanding" style="padding:18px 0 4px"><h3 style="margin-top:0">Kitchen Dashboard</h3><div class="grid">
        <button type="button" class="card" data-kitchen-page="menu" style="text-align:left"><b>Menu</b><div class="muted">Plan and manage monthly menus</div></button><button type="button" class="card" data-kitchen-page="prep" style="text-align:left"><b>Prep Amount</b><div class="muted">Prep quantities and production amounts</div></button><button type="button" class="card" data-kitchen-page="recipes" style="text-align:left"><b>Recipes</b><div class="muted">Kitchen recipe library</div></button><button type="button" class="card" data-kitchen-page="inventory" style="text-align:left"><b>Inventory</b><div class="muted">Kitchen products and stock</div></button><button type="button" class="card" data-kitchen-page="needs" style="text-align:left"><b>Needs Ordering</b><div class="muted">Kitchen items that need to be replenished</div></button><button type="button" class="card" data-kitchen-page="queues" style="text-align:left"><b>Order Queue</b><div class="muted">Kitchen orders waiting to be placed</div></button><button type="button" class="card" data-kitchen-page="todo" style="text-align:left"><b>To Do</b><div class="muted">Kitchen tasks and follow-ups</div></button>
    ...
    section.onclick=e=>{
      ...
      if(page==='menu'){const box=showPlaceholder();box.innerHTML='<div class="muted">Loading menu calendars…</div>';setKitchenActive();setTimeout(()=>{if(typeof window.loadKitchenMenuCalendar==='function')window.loadKitchenMenuCalendar();else box.innerHTML='<div class="muted">Menu calendar is still loading. Please try again.</div>';},30);return;}
      ...
      const titles={prep:'Prep Amount',todo:'To Do'};
      const desc={prep:'Kitchen prep quantities and production amounts will live here.',todo:'Kitchen tasks and follow-ups will live here.'};
